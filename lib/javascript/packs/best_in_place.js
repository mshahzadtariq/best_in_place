...
BestInPlaceEditor.forms = {
  "input" : {
    ...
    getValue : function() {
      return this.sanitizeValue(this.element.find(".input_text_field").val());
    },
  ...
  "textarea" : {
    activateForm : function() {
      ...
      this.element.html(output);
        $("textarea").cleditor({
            controls: "bold italic underline strikethrough | font size style | color highlight | bullets numbering | alignleft center alignright justify  | source"
        });
